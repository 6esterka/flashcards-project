export const uiText = {
  generate: {
    ...
    errorMessage: (errorText: string | undefined) =>
      `Flashcards generation failed: ${errorText}`,
  },
  home: {
    pageRouteTitle: "Home",
    ...
    navControls: {
      cardCounter: (currentIndex: number, total: number) =>
        `Card ${currentIndex + 1} of ${total}`,
      previousButton: "← Previous",
      nextButton: "Next →",
      learnedButton: "✅ Learned",
    },
    progressStat: (learnedCount: number, totalCount: number) =>
